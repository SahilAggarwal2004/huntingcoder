...
async function fetchblog(req, res) { // here, we can see that code is similar to node.js
    ...
    const data = await Blog.find({ name: slug }).select('-_id')
...
export default mongoConnect(fetchblog)